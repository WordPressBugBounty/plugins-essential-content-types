        ...
        if (current_theme_supports(self::CUSTOM_POST_TYPE)) : ?>
            <p><?php printf(
                    wp_kses_post(
                        ...
                        __('Your theme supports <strong>%s</strong>', 'essential-content-types')
                    ),
                    esc_html(self::CUSTOM_POST_TYPE)
                ); ?></p>
        <?php else : ?>
            ...
            printf(
                ...
                sprintf(
                    wp_kses_post(
                        ...
                        __('Portfolio pages display at most %1$s projects', 'essential-content-types')
                    ),
                    sprintf(
        ...
        $messages[self::CUSTOM_POST_TYPE] = array(
            ...
            1  => sprintf(
                wp_kses_post(
                    ...
                    __('Project updated. <a href="%s">View item</a>', 'essential-content-types')
                ),
            ...
            6  => sprintf(
                wp_kses_post(
                    ...
                    __('Project published. <a href="%s">View project</a>', 'essential-content-types')
                ),
                esc_url(get_permalink($post->ID))
            ),
            ...
            8  => sprintf(
                wp_kses_post(
                    // Translators: %s is a URL of a submitted post. 
                    __('Project submitted. <a target="_blank" href="%s">Preview project</a>', 'essential-content-types')
                ),
            ...
            9  => sprintf(
                wp_kses_post(
                    ...
                    __('Project scheduled for: <strong>%1$s</strong>. <a target="_blank" href="%2$s">Preview project</a>', 'essential-content-types')
                ),
            ...
            10 => sprintf(
                wp_kses_post(
                    ...
                    __('Project item draft updated. <a target="_blank" href="%s">Preview project</a>', 'essential-content-types')
                ),
                esc_url(add_query_arg('preview', 'true', get_permalink($post->ID)))
            ),
        );
...
<?php
    ...
    static function get_project_author()
    {
        ...
        $html .= sprintf(
            wp_kses_post(
                // Translators: %1$s is a URL of a author and %2$s is a author name 
