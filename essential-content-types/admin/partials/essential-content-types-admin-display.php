                        ...
                        <div class="content">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <?php $essential_content_types_ctp_options = ctp_get_options(); ?>
                                        <div class="module-header <?php echo $essential_content_types_ctp_options['theme_plugin_tabs'] ? 'active' : 'inactive'; ?>">
                                            <div class="switch">
                                                <input type="hidden" name="ctp_tabs_nonce" id="ctp_tabs_nonce" value="<?php echo esc_attr(wp_create_nonce('ctp_tabs_nonce')); ?>" />
                                                <input type="checkbox" id="ctp_options[theme_plugin_tabs]" class="ctp-switch" rel="theme_plugin_tabs" <?php checked(true, $essential_content_types_ctp_options['theme_plugin_tabs']); ?>>
                        ...
                        <div class="content">
                            <ul class="catchp-lists">
                                <li>
                                    ...
                                    <p><?php esc_html_e('Portfolio enables you to showcase your professional accomplishments to the world at large. Display your most impressive Portfolios in the way you like. You also have the option to choose your Portfolio layout up to 6 columns. A marvelous way to easily display your experience and expertise.', 'essential-content-types'); ?></p>
                                </li>

                                <li>
                                    <strong><?php esc_html_e('Testimonials', 'essential-content-types'); ?></strong>
                                    <p><?php esc_html_e('People are always after authenticity. They are always looking for ways to know what your goods or services are really like. Customer testimonials really help in building trust. You can customize the testimonials as you want and also select your testimonial layout type up to 6 columns.', 'essential-content-types'); ?></p>
                                </li>

                                <li>
                                    <strong><?php esc_html_e('Featured Content', 'essential-content-types'); ?></strong>
                                    <p><?php esc_html_e('Featured Content allows you to showcase your recent and popular posts on your website. Your Featured Content can be displayed up to 1 to 6 columns. Enable the Featured Content option and display your most impressive posts.', 'essential-content-types'); ?></p>
                                </li>

                                <li>
                                    <strong><?php esc_html_e('Services', 'essential-content-types'); ?></strong>
                                    <p><?php esc_html_e('Every website owner wants people to know about eh services they provide. You can place the services you provide right on the spotlight. Choose to display the services in 1 to 6 columns. Display your services and let the world know what you can provide them with.', 'essential-content-types'); ?></p>
                                </li>

                                <li>
                                    <strong><?php esc_html_e('Supports all themes on WordPress', 'essential-content-types'); ?></strong>
                                    <p><?php esc_html_e('You don’t have to worry if you have a slightly different or complicated theme installed on your website. It supports all the themes on WordPress and makes your website more striking and playful.', 'essential-content-types'); ?></p>
                                </li>

                                <li>
                                    <strong><?php esc_html_e('Lightweight', 'essential-content-types'); ?></strong>
                                    <p><?php esc_html_e('It is extremely lightweight. You do not need to worry about it affecting the space and speed of your website.', 'essential-content-types'); ?></p>
                                </li>

                                <li>
                                    <strong><?php esc_html_e('Order', 'essential-content-types'); ?></strong>
                                    <p><?php esc_html_e('You have the freedom to choose how your content would be displayed—whether in ascending or descending alphabetical order by author name, title, date, or in random order.', 'essential-content-types'); ?></p>
                                </li>

                                <li>
                                    <strong><?php esc_html_e('Enable/Disable any content/post type as needed', 'essential-content-types'); ?></strong>
                                    <p><?php esc_html_e('With this option, you can choose whether you want to display your content/post type or not. You can enable or disable any content or post type as per your need.', 'essential-content-types'); ?></p>
                                </li>

                                <li>
                                    <strong><?php esc_html_e('Super Simple to Set Up', 'essential-content-types'); ?></strong>
                                    <p><?php esc_html_e('It is super easy to set up. Even the beginners can set it up easily and also, you do not need to have any coding knowledge. Just install, activate, customize it your way and enjoy the plugin.', 'essential-content-types'); ?></p>
                                </li>

                                <li>
                                    <strong><?php esc_html_e('Responsive Design', 'essential-content-types'); ?></strong>
                                    <p><?php esc_html_e('One of the key features of our plugins is that your website will magically respond and adapt to different screen sizes delivering an optimized design for iPhones, iPads, and other mobile devices. No longer will you need to zoom and scroll around when browsing on your mobile phone.', 'essential-content-types'); ?></p>
                                </li>

                                <li>
                                    <strong><?php esc_html_e('Incredible Support', 'essential-content-types'); ?></strong>
                                    <p><?php esc_html_e('We have a great line of support team and support documentation. You do not need to worry about how to use the plugins we provide, just refer to our Tech Support Forum. Further, if you need to do advanced customization to your website, you can always hire our theme customizer!', 'essential-content-types'); ?></p>
                                </li>

                                <li>
                                    <strong><?php esc_html_e('Widgets', 'essential-content-types'); ?></strong>
                                    <p><?php esc_html_e('Multitude of widget options provide you with the option to choose the widgets that you want to display. You can have full control over each widget’s visibility and appearance. You can assign different contents on your sidebars, footer and any sidebar widgets.', 'essential-content-types'); ?></p>
                                </li>

                                <li>
                                    <strong><?php esc_html_e('Shortcodes', 'essential-content-types'); ?></strong>
                                    <p><?php esc_html_e('With Shortcodes, you have the option to use the powerful shortcode options to style multiple contents in completely different ways.', 'essential-content-types'); ?></p>
                                </li>

                                <li>
                                    <strong><?php esc_html_e('Number of Posts', 'essential-content-types'); ?></strong>
                                    <p><?php esc_html_e('You have the option to choose the number of posts you want to display on your website. Pick the number of posts that suits the best on your website.', 'essential-content-types'); ?></p>
                                </li>

                                <li>
                                    <strong><?php esc_html_e('Column Option', 'essential-content-types'); ?></strong>
                                    <p><?php esc_html_e('Column Option allows you to choose from multiple column options. Several options are available for all column types in general to edit the default behavior.', 'essential-content-types'); ?></p>
                                </li>
                            </ul>
                ...
                <div id="premium-extensions" class="wpcatchtab  save">
                    ...
                    <div class="about-text">
                        ...
                        <p><?php esc_html_e('You are currently using the free version of Essential Content Types.', 'essential-content-types'); ?><br />
                            <a href="https://catchplugins.com/plugins/" target="_blank"><?php esc_html_e('If you have purchased from catchplugins.com, then follow this link to the installation instructions (particularly step 1).', 'essential-content-types'); ?></a>
                        </p>
                    </div>
