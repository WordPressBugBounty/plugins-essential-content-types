...
<div class="hentry featured-content-entry">
    <header class="featured-content-entry-header entry-header">
        ...
        if (false != $atts['image'] && get_the_post_thumbnail() !== '') : ?>
            <div class="post-thumbnail">

                <?php echo wp_kses_post(essential_content_get_featured_content_thumbnail_link(get_the_ID(), $atts['image'])); ?>
        ...
        <?php if (false != $atts['display_types'] || false != $atts['display_tags'] || false != $atts['display_author']) : ?>
            <div class="featured-content-entry-meta entry-meta">
                ...
                if (false != $atts['display_types'] && Essential_Content_Featured_Content::get_content_type(get_the_ID())) {
                    echo wp_kses_post(Essential_Content_Featured_Content::get_content_type(get_the_ID()));
                }
                ...
                if (false != $atts['display_tags'] && Essential_Content_Featured_Content::get_content_tags(get_the_ID())) {
                    echo wp_kses_post(Essential_Content_Featured_Content::get_content_tags(get_the_ID()));
                }
                ...
                if (false != $atts['display_author'] && Essential_Content_Featured_Content::get_content_author(get_the_ID())) {
                    echo wp_kses_post(Essential_Content_Featured_Content::get_content_author(get_the_ID()));
                }
